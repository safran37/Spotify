...
import { MdOutlineQueueMusic, MdOpenInFull,MdPictureInPictureAlt } from "react-icons/md";
      ...
      <div className="min-w-[11.25rem] w-[30%]">
        {current && (
          <div className="flex items-center">
            ...
            {!sidebar && (<div className="w-14 h-14 relative group mr-3">
                <img src={current.img} alt="" />
                <button onClick={() => dispatch(setSidebar(true))} className="w-6 absolute opacity-0 group-hover:opacity-60 hover:!opacity-100 hover:scale-[1.06] top-1.5 right-1.5 rounded-full h-6 bg-black flex items-center justify-center">
